...
public class DoctorRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doc_reg_btn.setOnClickListener(v->{
            ...
            if(email_st.length()>5 && pass.length()>5 && fullname_st.length() > 3 && pass_st.equals(c_pass_st) && phone_st.length() > 7 && !deptxt.equals("Select Depertment") && !citytxt.equals("Select City")){
